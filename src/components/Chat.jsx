...
function Chat({ pp, contact, msg, time, unreadMsgs, active }) {
  return (
    // Chat container
    <div
      className={`flex justify-between items-center cursor-pointer w-100 h-[85px] px-3 hover:bg-[#202d3364] ${
        active ? "bg-[#202d3399]" : ""
      }`}
    >
      {/* Profile picture */}
      ...
      {/* Info container */}
      <div className="flex justify-between border-b border-neutral-700  w-100 h-100 py-3">
